...
noinst_PROGRAMS = fusexmp$(EXEEXT) FS$(EXEEXT)
subdir = example
...
FS_SOURCES = FS.c
FS_OBJECTS = FS.$(OBJEXT)
FS_LDADD = $(LDADD)
FS_DEPENDENCIES = ../lib/libfuse.la
...
SOURCES = FS.c fusexmp.c
DIST_SOURCES = FS.c fusexmp.c
ETAGS = etags
CTAGS = ctags
DISTFILES = $(DIST_COMMON) $(DIST_SOURCES) $(TEXINFOS) $(EXTRA_DIST)
ACLOCAL = ${SHELL} /root/Desktop/fuse-2.6.3/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /root/Desktop/fuse-2.6.3/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /root/Desktop/fuse-2.6.3/missing --run autoconf
AUTOHEADER = ${SHELL} /root/Desktop/fuse-2.6.3/missing --run autoheader
AUTOMAKE = ${SHELL} /root/Desktop/fuse-2.6.3/missing --run automake-1.9
AWK = gawk
BSD_FALSE = 
BSD_TRUE = #
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /root/Desktop/fuse-2.6.3/missing --run makeinfo
...
install_sh = /root/Desktop/fuse-2.6.3/install-sh
...
FS$(EXEEXT): $(FS_OBJECTS) $(FS_DEPENDENCIES) 
	@rm -f FS$(EXEEXT)
	$(LINK) $(FS_LDFLAGS) $(FS_OBJECTS) $(FS_LDADD) $(LIBS)
